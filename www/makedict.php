...
<body>
	<form method="post" action="">
		Zeichenpool ausw‰hlen:
		<br />
		<input type="checkbox" name="lowercase" value="true"> kleine Buchstaben
		<br />
		<input type="checkbox" name="uppercase" value="true"> groﬂe Buchstaben
		<br />
		<input type="checkbox" name="numbers" value="true"> Zahlen
		<br />
		<input type="checkbox" name="spcialchars" value="true"> Sonderzeichen
		<br />
		<input type="checkbox" name="userdefined" value="true"> Benutzerdefiniert (eins pro Zeile):
		<br />
		<textarea name="userdefined_data" rows=10 cols=50></textarea>
		<br />
		<br /> L&auml;nge:
		<input type="text" name="length" value="5" size="2">
		<br />
		<br />
		<input type="submit" />
	</form>
